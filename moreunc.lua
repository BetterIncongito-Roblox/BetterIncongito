...
--[[
 this is needed as of the enviroment not loading, you must execute this for 49 unc.
]]
...
funcs.hookfunction = function(func, rep)
...
funcs.getexecutorname = function()
	return 'BetterIncongito', Version
end
...
local Count = 0
local Total = 0
print('Running MoreUNC | BetterIncongito | Roblox', version(), ' | MoreUNC: https://discord.gg/gYhqMRBeZV')
